...
face_detection = cv2.CascadeClassifier('facial_expression_detection\haar_cascade_face_detection.xml')
...
model = tf.keras.models.load_model(r'facial_expression_detection\network-5Labels.h5')
